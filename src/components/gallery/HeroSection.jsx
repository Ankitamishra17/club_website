...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100svh] min-h-[100dvh] text-white overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex w-full flex-1 flex-col justify-center px-4 pt-24 pb-8 xs:px-5 sm:px-8 sm:pt-32 sm:pb-10 md:px-12 md:pt-24 lg:px-16 xl:px-16">
          ...
          <motion.div {...fadeUp()} className="ticket-stub w-fit max-w-full">
           ...
           Captured Moments · Chicane Experience
            </span>
          </motion.div>
  ...
  Step inside the unforgettable moments of Chicane Sports Bar & Club.
  From energetic dance floors and live performances to signature cocktails
  and premium interiors, our gallery captures the spirit of every celebration.          </motion.p>
